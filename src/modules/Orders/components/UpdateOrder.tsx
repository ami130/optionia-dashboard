...
const UpdateOrder = () => {
  ...
  const { data: singleOrder } = useGetSingleOrderQuery(Number(studentId));
  const [update, { isLoading, isSuccess }] = useUpdateOrderMutation();
  ...
  }, [form, isSuccess, navigate, singleOrder]);
    ...
    <div className="update-student-form">
      ...
      <Form form={form} onFinish={onFinish} isLoading={isLoading}>
        <Row gutter={[24, 24]}>
          ...
          <Col xs={24}>
            <Card
              title={<span className="section-title">Order Information</span>}
            ...
            >
              <Row gutter={[16, 16]}>
                ...
                <Col xs={24} sm={12}>
                  <Form.Item<any>
                    label={
                      <span className="form-label">Relation to Order</span>
                    }
