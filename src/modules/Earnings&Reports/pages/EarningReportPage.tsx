...
import useProductColumns from "../utils/earningReportColumns";
import { useGetEarningReportQuery } from "../api/earningReportEndPoints";

const EarningReportPage = () => {
