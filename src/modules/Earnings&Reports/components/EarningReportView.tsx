...
import { useGetSingleEarningReportQuery } from "../api/earningReportEndPoints";

const EarningReportView = () => {
  const { studentId } = useParams();
  const { data } = useGetSingleEarningReportQuery(Number(studentId));
...
export default EarningReportView;
