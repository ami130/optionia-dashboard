...
import { useCreateEarningReportMutation } from "../api/earningReportEndPoints";

const { Title, Text } = Typography;

const CreateEarningReport = () => {
  const [form] = AntForm.useForm();
  const navigate = useNavigate();
  const [create, { isLoading, isSuccess }] = useCreateEarningReportMutation();
  ...
  useEffect(() => {
    if (isSuccess) {
      message.success("EarningReport created successfully!");
      navigate("/students");
    }
  }, [isSuccess, navigate]);
...
export default CreateEarningReport;
