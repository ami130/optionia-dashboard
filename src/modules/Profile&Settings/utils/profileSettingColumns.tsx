...
import { useDeleteProfileSettingMutation } from "../api/profileSettingEndPoints";
...
const useProfileSettingColumns = (): ColumnsType<any> => {
  // const dispatch = useDispatch();
  const navigate = useNavigate();

  const { data: dashboardData } = useGetDashboardDataQuery({});
  const [deleteCartItem] = useDeleteProfileSettingMutation();
...
export default useProfileSettingColumns;
